        ...
        <div className="flex flex-col flex-wrap gap-[1rem]">
          ...
          <div className="basis-1/1">
            <div className={`relative mt-[1rem] md:mt-[0px]`}>
              ...
              <div className="bg-[#FF8A5B] absolute ml-[0px] pl-[0px] top-0 left-[-100vw] -z-50 min-w-[200vw] min-h-[100%]"/>
            </div>
          </div>
          ...
          <div className="basis-1/1">
            <Link href="/work/connectedhomehub"><Image className="justify-center max-w-[30rem] mx-auto" src={imgNext} alt=""/></Link>
          </div>
