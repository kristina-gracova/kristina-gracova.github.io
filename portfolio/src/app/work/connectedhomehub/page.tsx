        ...
        <div className="flex flex-col flex-wrap" id="start">
            <div className="basis-1/1">
              <div className="project-header-background">
                ...
                <Image className="project-header ml-[0vw] lg:ml-[15vw] w-[150vw] lg:w-[70vw]" src={headerImage} alt=""></Image>
              </div>
            </div>

            <div className="basis-1/1 mt-[1vh]">
              <div className={`tags-text text-[1.5vh] lg:text-[2.0vh] ml-[4vw] lg:ml-[27.5vw] mr-[4vw] lg:mr-[27.0vw]`}>
            ...
            <div className="basis-1/1 mt-[2vh]">
              <div className="heading-2 text-[3.0vh] lg:text-[3.5vh] ml-[4vw] lg:ml-[27.5vw] mr-[4vw] lg:mr-[27.0vw]">About</div>
            </div>

            <div className="basis-1/1 mt-[1vh]">
              <div className={`project-text text-[1.5vh] lg:text-[2.0vh] ml-[4vw] lg:ml-[27.5vw] mr-[4vw] lg:mr-[27.0vw]`}>
            ...
            <div className="basis-1/1 mt-[1vh]">
              <Image className="ml-[25vw] lg:ml-[35vw] w-[50vw] lg:w-[30vw]" src={iphoneImage} alt=""></Image>
            </div>

            <div className="basis-1/1">
              <div className="flex flex-row gap-[5vw]">
                <div className="basis-1/2">
                  <div className="heading-2 text-[3.0vh] lg:text-[3.5vh] ml-[4vw] lg:ml-[27.5vw]">Goal</div>
                  <div className={`project-text text-[1.5vh] lg:text-[2.0vh] ml-[4vw] lg:ml-[27.5vw]`}>
                ...
                <div className="basis-1/2">
                  <div className="heading-2 text-[3.0vh] lg:text-[3.5vh] mr-[4vw] lg:mr-[27.0vw]">My role</div>
                  <div className={`project-text text-[1.5vh] lg:text-[2.0vh] mr-[4vw] lg:mr-[27.0vw]`}>
            ...
            <div className="basis-1/1 mt-[3vh] lg:mt-[5vh]">
              <Image className="ml-[25vw] lg:ml-[35vw] w-[50vw] lg:w-[30vw]" src={circleImage} alt=""></Image>
            </div>

            <div className="basis-1/1 mt-[4vh]">
              <div className="heading-2 text-[3.0vh] lg:text-[3.5vh] ml-[4vw] lg:ml-[27.5vw] mr-[4vw] lg:mr-[27.0vw]">Getting started</div>
            </div>
            ...
            <div className="basis-1/1 mt-[1vh]">
              <div className="heading-2 text-[3.0vh] lg:text-[3.5vh] ml-[4vw] lg:ml-[27.5vw] mr-[4vw] lg:mr-[27.0vw]">Learning from data</div>
            </div>
            ...
            <div className="basis-1/1 mt-[1vh]">
              <div className={`project-text text-[1.5vh] lg:text-[2.0vh] ml-[4vw] lg:ml-[27.5vw] mr-[4vw] lg:mr-[27.0vw]`}>
                ...
                <ul className="list-disc list-outside mt-[2vh] ml-[3vw] lg:ml-[1vw]">
            ...
            <div className="basis-1/1 mt-[1vh]">
              <div className="heading-2 text-[3.0vh] lg:text-[3.5vh] ml-[4vw] lg:ml-[27.5vw] mr-[4vw] lg:mr-[27.0vw]">Optimising heating</div>
            </div>
            ...
            <div className="basis-1/1 mt-[1vh]">
              <div className="heading-2 text-[3.0vh] lg:text-[3.5vh] ml-[4vw] lg:ml-[27.5vw] mr-[4vw] lg:mr-[27.0vw]">Automating for efficiency</div>
            </div>
            ...
            <div className="basis-1/1 mt-[1vh]">
              <div className="heading-2 text-[3.0vh] lg:text-[3.5vh] ml-[4vw] lg:ml-[27.5vw] mr-[4vw] lg:mr-[27.0vw]">Embracing sustainability</div>
            </div>
