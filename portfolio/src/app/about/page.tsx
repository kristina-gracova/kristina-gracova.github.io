  ...
  return (
    <main>
      <div className="flex flex-col flex-wrap min-w-[100vw] min-h-[100vh]">
        <Navbar/>
        <Slider name="About"/>
        <div className={`flex flex-row flex-wrap md:flex-nowrap ${junge.variable}`}>
          <div className="basis-1/1 md:basis-2/12"/>
          <div className="basis-1/1 md:basis-5/12">
            <div className="heading-2 text-[4vh] md:text-[10vh] ml-[3vw] md:ml-[-2vw] mr-[3vw] pb-12">Hi, I’m Kristina</div>
            <div className={`project-text text-[2.5vh] md:text-[3vh] ml-[3vw] md:ml-[-2vw] mr-[3vw] pb-12 ${qcs.variable}`}>
            ...
            <div className={`project-text text-[2.5vh] md:text-[3vh] ml-[3vw] md:ml-[-2vw] mr-[3vw] ${qcs.variable}`}>
          ...
          <div className="basis-0/1 md:basis-5/12"/>
        </div>
      </div>
    </main>
  );
